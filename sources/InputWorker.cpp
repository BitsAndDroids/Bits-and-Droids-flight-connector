...
void InputWorker::switchHandling(int index) {
  Sleep(10);
  //
  if (sizeof(receivedString) > 2) {
    ...
    try {
      ...
      switch (prefixVal) {
          ...
          //              case 9: {
          //                try {
          //                  std::string incommingText;
          //                  token = strtok_s(receivedString, " ",
          //                  &next_token);

          //                  counter = 0;

          //                  while (token != nullptr) {
          //                    cout << receivedString << ":Received" <<
          //                    endl; cout << token << ":Counter" <<
          //                    counter << endl;
          ...
          //                  SimConnect_Text(
          //                      hInputSimConnect,
          //                      SIMCONNECT_TEXT_TYPE_PRINT_WHITE, 0, 0,
          //                      sizeof(incommingText), (void
          //                      *)incommingText.c_str());
        ...
        case 199: {
          ...
          if (advanced) {
            SimConnect_SetDataOnSimObject(
                ...
                SIMCONNECT_OBJECT_ID_USER, 0, 0, sizeof(mc.mixture_percent),
                &mc.mixture_percent);
          }

          SimConnect_SetDataOnSimObject(hInputSimConnect, DEFINITION_THROTTLE_1,
                                        SIMCONNECT_OBJECT_ID_USER, 0, 4,
                                        sizeof(tc.throttle_percent[0]),
                                        &tc.throttle_percent[0]);

          SimConnect_SetDataOnSimObject(hInputSimConnect, DEFINITION_THROTTLE_2,
                                        SIMCONNECT_OBJECT_ID_USER, 0, 4,
                                        sizeof(tc.throttle_percent[1]),
                                        &tc.throttle_percent[1]);

          SimConnect_SetDataOnSimObject(hInputSimConnect, DEFINITION_THROTTLE_3,
                                        SIMCONNECT_OBJECT_ID_USER, 0, 4,
                                        sizeof(tc.throttle_percent[2]),
                                        &tc.throttle_percent[2]);

          SimConnect_SetDataOnSimObject(hInputSimConnect, DEFINITION_THROTTLE_4,
                                        SIMCONNECT_OBJECT_ID_USER, 0, 4,
                                        sizeof(tc.throttle_percent[3]),
        ...
        case 100: {
          ...
          SimConnect_TransmitClientEvent(
              hInputSimConnect, SIMCONNECT_OBJECT_ID_USER, DEFINITION_COM_1_SET,
              Dec2Bcd(value / 10), SIMCONNECT_GROUP_PRIORITY_HIGHEST,
        ...
        case 102: {
          int value = stoi(std::string(&receivedString[index][4],
                                       &receivedString[index][10]));
          SimConnect_TransmitClientEvent(
              hInputSimConnect, SIMCONNECT_OBJECT_ID_USER, DEFINITION_COM_2_SET,
              Dec2Bcd(value / 10), SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          if (value % (value / 10) == 5 || value % (value / 10) == 85) {
            SimConnect_TransmitClientEvent(
        ...
        case 111: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_COM1_RADIO_WHOLE_DEC, 0,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 112: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_COM1_RADIO_WHOLE_INC, 0,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
        ...
        case 113: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_COM2_RADIO_WHOLE_DEC, 0,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 114: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_COM2_RADIO_WHOLE_INC, 0,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        ...
        case 122: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_COM2_RADIO_FRACT_DEC_CARRY, 0,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 123: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_COM2_RADIO_FRACT_INC_CARRY, 0,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        ...
        case 126: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_COM_RADIO_FRACT_DEC_CARRY, 0,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 127: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_COM_RADIO_FRACT_INC_CARRY, 0,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        ...
        case 136: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_DME1_IDENT_ENABLE,
        ...
        case 137: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_DME1_IDENT_DISABLE,
              0, SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 138: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_DME1_IDENT_SET, 0,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 139: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_DM1E_IDENT_TOGGLE,
              0, SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 140: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_DME2_IDENT_ENABLE,
              0, SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 141: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_DME2_IDENT_DISABLE,
              0, SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 142: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_DME2_IDENT_SET, 0,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 143: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_DME2_IDENT_TOGGLE,
              0, SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        ...
        case 145: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_VOR1_IDENT_ENABLE,
              0, SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 146: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_VOR1_IDENT_DISABLE,
              0, SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        ...
        case 147: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_VOR1_IDENT_SET, 0,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 148: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_VORE_IDENT_TOGGLE,
              0, SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 149: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_VOR2_IDENT_ENABLE,
              0, SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 150: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_VOR2_IDENT_DISABLE,
              0, SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 151: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_VOR2_IDENT_SET, 0,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 152: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_VOR2_IDENT_TOGGLE,
              0, SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        ...
        case 158: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_ADF_IDENT_ENABLE,
              0, SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 159: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_ADF_IDENT_DISABLE,
              0, SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 160: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_ADF_IDENT_SET, 0,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 161: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_RADIO_SELECTED_ADF_IDENT_TOGGLE,
              0, SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        ...
        case 202: {
          ...
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_XPNDR_SET, Dec2Bcd(stoi(value)),
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        ...
        case 357: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_AP_PANEL_SPEED_HOLD_TOGGLE, 0,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 358: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_AP_PANEL_MACH_HOLD_TOGGLE, 0,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        ...
        case 401: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_TOGGLE_AVIONICS1_MASTER_OFF, 0,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 402: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_TOGGLE_AVIONICS1_MASTER_ON, 1,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 403: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_TOGGLE_AVIONICS2_MASTER_OFF, 0,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
        case 404: {
          SimConnect_TransmitClientEvent(
              hInputSimConnect, 0, DEFINITION_TOGGLE_AVIONICS2_MASTER_ON, 1,
              SIMCONNECT_GROUP_PRIORITY_HIGHEST,
              SIMCONNECT_EVENT_FLAG_GROUPID_IS_PRIORITY);
          break;
        }
...
void InputWorker::inputEvents() {
  ...
  if (SUCCEEDED(
    ...
    std::cout << "Is connected: " << arduinoInput[0]->isConnected()
              << std::endl;
    ...
    while (abortInput != true) {
      const auto hasRead0 =
          arduinoInput[0]->readSerialPort(receivedString[0], DATA_LENGTH);
      ...
      if (extraRows > 0) {
        const auto hasRead1 =
            arduinoInput[1]->readSerialPort(receivedString[1], DATA_LENGTH);
        if (hasRead1) {
          switchHandling(1);
        }
      }
      if (extraRows > 1) {
        const auto hasRead2 =
            arduinoInput[2]->readSerialPort(receivedString[2], DATA_LENGTH);
      ...
      if (extraRows > 2) {
        const auto hasRead3 =
            arduinoInput[3]->readSerialPort(receivedString[3], DATA_LENGTH);
        if (hasRead3) {
          switchHandling(3);
        }
      }
      if (extraRows > 3) {
        const auto hasRead4 =
            arduinoInput[4]->readSerialPort(receivedString[4], DATA_LENGTH);
        if (hasRead4) {
          switchHandling(4);
        }
      }
      if (extraRows > 4) {
        const auto hasRead5 =
            arduinoInput[5]->readSerialPort(receivedString[5], DATA_LENGTH);
        if (hasRead5) {
          switchHandling(5);
        }
      }
      if (extraRows > 5) {
        const auto hasRead6 =
            arduinoInput[6]->readSerialPort(receivedString[6], DATA_LENGTH);
      ...
      if (extraRows > 6) {
        const auto hasRead7 =
            arduinoInput[7]->readSerialPort(receivedString[7], DATA_LENGTH);
        if (hasRead7) {
          switchHandling(7);
        }
      }
      if (extraRows > 7) {
        const auto hasRead8 =
            arduinoInput[8]->readSerialPort(receivedString[8], DATA_LENGTH);
      ...
      if (extraRows > 8) {
        const auto hasRead9 =
            arduinoInput[9]->readSerialPort(receivedString[9], DATA_LENGTH);
        if (hasRead9) {
          switchHandling(9);
        }
      }
  ...
  if (extraRows > 0) {
    arduinoInput[1]->closeSerial();
  }
  if (extraRows > 1) {
    arduinoInput[2]->closeSerial();
  }
  if (extraRows > 2) {
    arduinoInput[3]->closeSerial();
  }
  if (extraRows > 3) {
    arduinoInput[4]->closeSerial();
  }
  if (extraRows > 4) {
    arduinoInput[5]->closeSerial();
  }
  if (extraRows > 5) {
    arduinoInput[6]->closeSerial();
  }
  if (extraRows > 6) {
    arduinoInput[7]->closeSerial();
  }
  if (extraRows > 7) {
    arduinoInput[8]->closeSerial();
  }
  if (extraRows > 8) {
    arduinoInput[9]->closeSerial();
  }
  quit();
}
