  ...
  if (strlen(receivedString[index]) > 2) {
    ...
    try {
      ...
      switch (prefixVal) {
        ...
        case 753: {
          sendBasicCommand(
              inputDefinitions.DEFINITION_G1000_PFD_FLIGHTPLAN_BUTTON, index);
          break;
        }
        case 754: {
          sendBasicCommand(
              inputDefinitions.DEFINITION_G1000_PFD_PROCEDURE_BUTTON, index);
          break;
        }
        case 755: {
          break;
        ...
        case 757: {
          sendBasicCommand(
              inputDefinitions.DEFINITION_G1000_PFD_DIRECTTO_BUTTON, index);
          break;
        }
        case 758: {
        ...
        case 762: {
          sendBasicCommand(inputDefinitions.DEFINITION_G1000_PFD_GROUP_KNOB_INC,
                           index);
          break;
        }
        case 763: {
          sendBasicCommand(inputDefinitions.DEFINITION_G1000_PFD_GROUP_KNOB_DEC,
                           index);
          break;
        }
        case 764: {
        ...
        case 778: {
          sendBasicCommand(
              inputDefinitions.DEFINITION_G1000_MFD_FLIGHTPLAN_BUTTON, index);
          break;
        }
        case 779: {
          sendBasicCommand(
              inputDefinitions.DEFINITION_G1000_MFD_PROCEDURE_BUTTON, index);
          break;
        }
        case 780: {
        ...
        case 781: {
          sendBasicCommand(inputDefinitions.DEFINITION_G1000_MFD_ZOOMOUT_BUTTON,
                           index);
          break;
        }
        case 782: {
          sendBasicCommand(
              inputDefinitions.DEFINITION_G1000_MFD_DIRECTTO_BUTTON, index);
          break;
        }
        case 783: {
        ...
        case 787: {
          sendBasicCommand(inputDefinitions.DEFINITION_G1000_MFD_GROUP_KNOB_INC,
                           index);
          break;
        }
        case 788: {
          sendBasicCommand(inputDefinitions.DEFINITION_G1000_MFD_GROUP_KNOB_DEC,
                           index);
          break;
        }
        case 789: {
