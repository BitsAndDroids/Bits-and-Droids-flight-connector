...
QT_MOC_LITERAL(68, 18), // "GameConnectionMade"
QT_MOC_LITERAL(87, 3), // "con"
QT_MOC_LITERAL(91, 4), // "mode"
QT_MOC_LITERAL(96, 19) // "BoardConnectionMade"
...
void OutputWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (OutputWorker::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OutputWorker::GameConnectionMade)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (OutputWorker::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OutputWorker::BoardConnectionMade)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 2
void OutputWorker::GameConnectionMade(int _t1, int _t2)
{
...
// SIGNAL 3
void OutputWorker::BoardConnectionMade(int _t1, int _t2)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))), const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t2))) };
